...
export const initialEventCards: Omit<EventCard, 'id' | 'isAIGenerated'>[] = [
  ...
  // 日常经营事件
  {
    ...
    leftEffects: { reputation: 5, profit: -15, staffMorale: 3 },
    rightEffects: { reputation: -8, profit: 12, customerFlow: -2 },
    rarity: 'common',
  },

  {
    ...
    leftEffects: { profit: -12, staffMorale: 15, reputation: 3 },
    rightEffects: { profit: 5, staffMorale: -10, customerFlow: -5 },
    rarity: 'common',
  },

  {
    ...
    leftEffects: { reputation: 8, profit: 0, customerFlow: -3 },
    rightEffects: { reputation: -5, profit: -8, customerFlow: 20 },
    rarity: 'uncommon',
  },
  ...
  // 危机事件
  {
    ...
    rightChoice: '不涨，咬牙硬撑',
    leftEffects: { profit: 10, reputation: -12, customerFlow: -8 },
    rightEffects: { profit: -15, reputation: 8, customerFlow: 5 },
    rarity: 'uncommon',
  },

  {
    ...
    leftEffects: { reputation: 5, profit: -5, customerFlow: -3 },
    rightEffects: { reputation: -8, profit: -10, customerFlow: 8 },
    rarity: 'rare',
  },
  ...
  // 机遇事件
  {
    ...
    leftEffects: { profit: 25, reputation: -5, staffMorale: -10 },
    rightEffects: { profit: 0, reputation: 5, staffMorale: 8 },
    rarity: 'rare',
  },

  {
    ...
    leftEffects: { reputation: 12, customerFlow: 15, profit: -3 },
    rightEffects: { reputation: 3, customerFlow: -2, staffMorale: 5 },
    rarity: 'uncommon',
  },
  ...
  // 员工相关事件
  {
    ...
    leftEffects: { staffMorale: 8, profit: -8, reputation: 5 },
    rightEffects: { staffMorale: -12, customerFlow: 3, reputation: -3 },
    rarity: 'common',
  },

  {
    ...
    rightChoice: '部分使用预制菜',
    leftEffects: { reputation: 8, customerFlow: -10, staffMorale: 5 },
    rightEffects: { reputation: -12, customerFlow: 15, profit: 8 },
    rarity: 'common',
  },
  ...
  // 社会热点事件
  {
    ...
    leftEffects: { reputation: -5, customerFlow: -8, staffMorale: 5 },
    rightEffects: { reputation: -15, customerFlow: 3, profit: 5 },
    rarity: 'uncommon',
  },

  {
    ...
    leftEffects: { profit: -15, staffMorale: 20, reputation: 8 },
    rightEffects: { profit: 5, staffMorale: -15, reputation: -12 },
    rarity: 'rare',
  },
]
